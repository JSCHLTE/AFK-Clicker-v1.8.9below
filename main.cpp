...
void clicker()
{
	...
	while (true)
	{
		...
		if (click == true) 
		{
			...
			Sleep(1); //Adujst Speed | (Warning settings this value below 1 WILL cause come crashes. Try at your own risk. THE LOWER THE VALUE THE FASTER)
		}
		//Right Click
